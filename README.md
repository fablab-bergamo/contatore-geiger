...
- **Microcontrollore**: ESP32 (testato su [LILYGO T-DISPLAY](https://lilygo.cc/products/lilygo%C2%AE-ttgo-t-display-1-14-inch-lcd-esp32-control-board))
- **Display**: ST7789 TFT 240x135 pixel (integrato nella board T-DISPLAY)
- **Rilevatore di radiazioni**: CAJOE RadiationD v1.1
- **Tubo Geiger**: J305β
...
│   │   └── Unispace12x24.c   
│   └── scheda BergamoScienza.pdf
├── measurements/             # Dati sperimentali
│   └── grafico radiazione - distanza.pdf
...
- Il dispositivo è per uso educativo e dimostrativo
- Per misurazioni critiche di dose, utilizzare strumentazione certificata
...
Progetto educativo per BergamoScienza sviluppato da Alex Brunot. Il codice è basato su librerie open source per MicroPython.